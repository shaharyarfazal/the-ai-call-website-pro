...
const industries = [
  ...
  { icon: <Car className="h-5 w-5" />, name: "Auto Services", stat: "2x", result: "more jobs booked", detail: "AI captures vehicle info, diagnoses urgency, and books service appointments.", color: "text-amber-400", bg: "bg-amber-500/10", border: "border-amber-500/15" },
